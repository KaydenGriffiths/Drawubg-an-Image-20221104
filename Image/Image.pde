...
void setup()
{
  ...
  int picHeight1 = 600;
  int picWidth2 = 2000;//Bike image
  int picHeight2 = 1400;
  int picWidth3 = 675;// Vader image
  int picHeight3 = 1200;
  //
  ...
  if ( picWidth1 >= picHeight1 ) { //True if Landscape or Square
    ...
    if ( picHeightAdjusted1 > backgroundImageHeight+1 ) { //Error Catch
      println (picHeightAdjusted1, picWidthAdjusted1);
  ...
  if ( picWidth3 >= picHeight3 ) { //True if Landscape or Square
    ...
    //
    //Students to create
    picHeightAdjusted3 = bottomWidth; //stretch or reduce
